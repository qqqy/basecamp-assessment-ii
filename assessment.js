...
message["text"] = "Is we boff strings?";
...
var adjustCount = {
  upVote(num){num += 1; return num} ,
  downVote(num){num -= 1; return num}
}
/**
 * #5
 *
...
function indexFinder(arr){
  return arr.map((val,i,ary) => {return i; console.log(i)} );
}
